...
/****** Object:  Database [timetable_db]    Script Date: 17.06.2021 7:21:57 ******/
CREATE DATABASE [timetable_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'timetable_db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\timetable_db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'timetable_db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\timetable_db_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [timetable_db] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [timetable_db] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
